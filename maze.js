! function(hate, width, maze, walls, currentPosition) {
  hate = hate % 2 == 0 ? hate + 1 : hate; // в статье было объ€снено, почему числа должны быть нечетными
...
}(parseInt(prompt('¬ведите высоту лабиринта:')), parseInt(prompt('¬ведите ширину лабиринта:')), [], [], [0, 0])
